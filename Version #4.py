...
def fillLitter():
    ...
    global disLitter, lastTime
    
    disLitter = (pygame.time.get_ticks()) - lastTime
    print("fillLitter",(pygame.time.get_ticks()),disLitter,lastTime)
    
    sX.append(800)
    sY.append(random.randint(200,550))
    sSpeed.append(random.randrange(3,15))
    ...
    print("fillLitter2",(pygame.time.get_ticks()),disLitter,lastTime)
...
def addLitter():
    global mx, my
    global sX, sY, sSpeed, sLength, sHeight, sSection, sLitter, sType
    global motionTime, disLitter, lastTime
    
    lastTime = (pygame.time.get_ticks())
    print("addLitter",(pygame.time.get_ticks()),disLitter,lastTime)
    print("addLitter2", (pygame.time.get_ticks()) - disLitter)
    if (pygame.time.get_ticks()) - disLitter >= 3000:     
        lastTime = disLitter
        fillLitter()
    else:
        print("No")
...
def drawScene(screen, mx, my, button):
    global state
    global motionTime, disLitterTime, gameTime
