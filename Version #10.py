...
def fillLitter():
    ...
    sX.append(800)
    sY.append(random.randint(300,550)) # 200shezhile
    ...
    sTime.append(pygame.time.get_ticks())
    print(sTime)
...
def playGame(screen, mx, my, button):
    ...
    text1 = fontHello.render(str(clockCount),0,BLACK)
    screen.blit(text1,pygame.Rect(500,70,70,70))        
...
def instrPage(screen,mx,my,button):
    ...
    mousePic = pygame.transform.scale(mousePic, (50, 50)) # mouse
    screen.blit(mousePic,(100,100,800,200))
    
    fishPic = pygame.transform.scale(fishPic, (50, 50)) # fish
    screen.blit(fishPic,(200,200, 50, 50))
    Garbage1 = pygame.transform.scale(Garbage1, (50, 50)) # garbage 
    screen.blit(Garbage1,(150,150, 50, 50))
    Garbage2 = pygame.transform.scale(Garbage2, (50, 50))  # garbage 
    screen.blit(Garbage2,(150,200, 50, 50))
    Garbage3 = pygame.transform.scale(Garbage3, (50, 50))  # garbage 
    screen.blit(Garbage3,(130,130, 50, 50))
    Garbage4 = pygame.transform.scale(Garbage4, (50, 50))  # garbage 
    screen.blit(Garbage4,(210,200, 50, 50))
    Garbage5 = pygame.transform.scale(Garbage5, (50, 50))  # garbage 
    screen.blit(Garbage5,(240,330, 50, 50))
    heartPic = pygame.transform.scale(heartPic, (50, 50))  # heart
    screen.blit(heartPic,(240,330, 50, 50))
    bombPic = pygame.transform.scale(bombPic, (50, 50))  # bomb 
    screen.blit(bombPic,(240,330, 50, 50))
